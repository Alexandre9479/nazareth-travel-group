...
export const PACKAGES: Package[] = [
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1504093376055-b3094b660b3e?w=800&q=80",
    gallery: [
      "https://images.unsplash.com/photo-1504093376055-b3094b660b3e?w=800&q=80",
      "https://images.unsplash.com/photo-1549488344-1f9b8d2bd1f3?w=800&q=80",
    ],
    ...
    featured: true,
    itinerary: [
      { day: 1, title: "Departure from Nairobi", description: "Your sacred journey begins. Overnight flight to Tel Aviv." },
      { day: 2, title: "Arrival · Tel Aviv · Jerusalem", description: "Welcome arrival, transfer to your boutique hotel in Jerusalem. Evening stroll through the Old City lanes." },
      { day: 3, title: "Jerusalem — Sacred Morning", description: "Private tour of the Via Dolorosa, Church of the Holy Sepulchre, and Western Wall. Afternoon at leisure. Romantic dinner in the Old City." },
      { day: 4, title: "Mount of Olives · Bethlehem", description: "Sunrise on the Mount of Olives together. Visit Gethsemane. Afternoon in Bethlehem — the Church of the Nativity and Shepherd's Field." },
      { day: 5, title: "Nazareth · Cana · Sea of Galilee", description: "Drive north. Visit Cana — site of Jesus' first miracle at the wedding feast. Arrive at the Sea of Galilee. Sunset boat ride on the still water." },
      { day: 6, title: "Galilee — Day of Renewal", description: "Sunrise at the Mount of Beatitudes. Capernaum ruins. Private Jordan River vow renewal ceremony with your guide. Celebration dinner." },
      { day: 7, title: "Galilee at leisure", description: "A restful day by the sea. Swim, walk, pray, or simply be still together." },
      { day: 8, title: "Jericho · Jerusalem", description: "Visit ancient Jericho. Return to Jerusalem for a final Old City evening." },
      { day: 9, title: "Jerusalem — Farewell Morning", description: "Final prayers at the Holy Sepulchre. Afternoon free. Farewell dinner." },
      { day: 10, title: "Departure", description: "Transfer to Tel Aviv. Fly home as one — transformed by where you began." },
    ],
  },
];
